...
const data = {
  ...
  meta_description: categoryInput.description,
...
<ul className="nav nav-tabs" id="myTab" role="tablist">
  ...
  <li className="nav-item" role="presentation">
    <button className="nav-link" id="seo-tag-tab" data-bs-toggle="tab" data-bs-target="#seo-tags" type="button" role="tab" aria-controls="profile" aria-selected="false">SEO tags</button>
  </li>
